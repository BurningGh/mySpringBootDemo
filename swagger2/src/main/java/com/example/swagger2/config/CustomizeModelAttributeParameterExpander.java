...
public class CustomizeModelAttributeParameterExpander extends ModelAttributeParameterExpander {
    ...
    protected final DocumentationPluginsManager pluginsManager;

    public CustomizeModelAttributeParameterExpander(FieldProvider fields, AccessorsProvider accessors, EnumTypeDeterminer enumTypeDeterminer, DocumentationPluginsManager pluginsManager) {
